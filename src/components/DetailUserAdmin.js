...
export default function DetailUserAdmin(props) {
  ...
  return (
    <div>
      ...
      <Dialog fullScreen open={open} onClose={handleClose} TransitionComponent={Transition}>
        <AppBar className={classes.appBar}>
          <Toolbar>
            ...
            <Typography variant="h6" className={classes.title}>
              {dataService.firstName + " " + dataService.lastName }
            </Typography>
        ...
        <List>
          <ListItem >
            <ListItemText primary="Sobre mi" secondary={dataService.aboutMe} />
          </ListItem>
          <Divider />
          <ListItem >
            <ListItemText primary="Experiencia " secondary={dataService.experience} />
          </ListItem>
          <Divider />
          {/* <ListItem >
